...
def process_file_task(self, file_id: str, file_bytes_hex: str, filename: str, file_type: str, client_id: str, project_id: str | None):
    """Celery task: parse, chunk, embed, and index a file."""
    try:
        asyncio.run(_process_file(file_id, file_bytes_hex, filename, file_type, client_id, project_id))
